...
/** Couriers — responsive HTML hero (same photo + live copy on all locales/viewports). */
function CouriersHero({ hero, role }: { hero: HeroContent; role: Role }) {
  return (
    <section id="hero" className="careers-hero careers-hero--couriers">
      <div className="careers-hero__figma careers-hero__figma--couriers careers-hero__figma--responsive">
        <div className="careers-hero__figma-photo">
          <div className="careers-hero__figma-photo-frame">
            <Image
              ...
              priority
              unoptimized
              className="careers-hero__figma-photo-img careers-hero__figma-photo-img--couriers"
